...
int main(int argc, char **argv)
{
    ...
    W[3]=1.0;
    W[4]=1.0;
    w.setcontent(W.size(), &(W[0]));
    //real_1d_array w = "[1,1]";
    //real_1d_array xc = "[0.5,0.5]";
    //real_1d_array yc = "[0.5,0.5]";
    //integer_1d_array dc = "[0,1]";
    real_1d_array xc = "[0.5]";
    real_1d_array yc = "[0.5]";
    integer_1d_array dc = "[0]";
    ae_int_t m = 2;//3;
    ae_int_t info;
    barycentricinterpolant p;
